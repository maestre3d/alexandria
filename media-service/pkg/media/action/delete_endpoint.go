...
func MakeDeleteMediaEndpoint(svc service.IMediaService, logger log.Logger, duration metrics.Histogram, tracer stdopentracing.Tracer, zipkinTracer *stdzipkin.Tracer) endpoint.Endpoint {
	...
	// Transport metrics
	ep = shared.LoggingMiddleware(log.With(logger, "method", "media.delete"))(ep)
	ep = shared.InstrumentingMiddleware(duration.With("method", "media.delete"))(ep)
