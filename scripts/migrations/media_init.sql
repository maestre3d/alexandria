...
CREATE DATABASE alexandria_media;
\c alexandria_media

-- Media Entity
CREATE TYPE PUBLIC.MEDIA_ENUM AS ENUM(
	'MEDIA_BOOK',
	'MEDIA_DOC',
	'MEDIA_PODCAST',
	'MEDIA_VIDEO'
...
CREATE TABLE IF NOT EXISTS PUBLIC.MEDIA(
	...
	MEDIA_TYPE		PUBLIC.MEDIA_ENUM NOT NULL DEFAULT 'MEDIA_BOOK',
...
INSERT INTO PUBLIC.MEDIA(EXTERNAL_ID, TITLE, DISPLAY_NAME, DESCRIPTION, USER_ID, AUTHOR_ID)
VALUES (
